...
export function calcularMaoObraCasaDetalhada(params: ParametrosMaoObraCasa): MaoObraCasaDetalhada {
  ...
  // volumeCinta = perimetroExterno * 0.1 * 0.1 - para referência futura
  ...
  // areaJanelas = (qtdQuartos + qtdBanheiros + 2) * 1.5 - para referência futura
  ...
  // qtdSoleiras = qtdQuartos + qtdBanheiros + 3 - para referência futura
  ...
  // areaPinturaTotal = areaPinturaInterna + areaPinturaExterna - para referência futura
